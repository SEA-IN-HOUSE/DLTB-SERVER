...
export async function SyncToFileMakerTORRemittanceController(request: Request, response : Response){

    try{

      
 
        const updateTORMain = await TORRemittanceService.SyncDataByCoopid(request.params.coopId)

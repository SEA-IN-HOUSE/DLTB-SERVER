...
export async function SyncToFileMakerTORViolationController(request: Request, response : Response){

    try{

      
 
        const updateTORMain = await TORViolationService.SyncDataByCoopid(request.params.coopId)

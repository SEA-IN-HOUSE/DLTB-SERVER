            ...
            try{
                ...
                tors.map(async (tor: any) => {
                    ...
                    try {
                        ...
                        const request = await axios.post(`${process.env.DLTB_API_CREATE_TOR}/tor_violation/records`, bodyParameters, config);
                    ...
                    const updateStatusOfTor = await TORViolationRepository.UpdateIsUploaded(tor.fieldData[0].id, true);
                });
